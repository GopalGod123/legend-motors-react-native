...
import {getUserProfile, syncAuthToken, logoutUser, updateUserProfile} from '../services/api';
...
const ProfileScreen = () => {
  ...
  const uploadProfileImage = async (imageAsset) => {
    try {
      ...
      const uploadResponse = await fetch('https://api.legendmotorsglobal.com/api/upload', {
        method: 'POST',
        body: formData,
        headers: {
            ...
            <TouchableOpacity
              ...
              {showTooltip && (
                <View style={styles.tooltipContainer}>
                  <Text style={styles.tooltipText}>Tap the pencil icon to change your profile picture</Text>
                </View>
              )}
            </TouchableOpacity>

...
import {styles} from './helpCenterScreenStyle';
...
// Facebook Icon
const FacebookIcon = () => (
  <Svg width="24" height="24" viewBox="0 0 24 24" fill="#EF9539">
    <Path
      ...
      return (
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity style={styles.retryButton} onPress={handleRefresh}>
            <Text style={[styles.retryButtonText, {color: COLORS1?.textDark}]}>
              Try Again
            </Text>
          </TouchableOpacity>
        </View>
      ...
      <View style={[styles.tabContent, {backgroundColor: COLORS1.background}]}>
        ...
        <View
          style={[
            ...
            {borderColor: COLORS1?.white, backgroundColor: COLORS1?.white},
          ]}>
          <View style={styles.searchIcon}>
            <SearchIcon color={COLORS1?.search} />
          </View>
          <TextInput
            style={[styles.searchInput, {color: COLORS1.textDark}]}
          ...
          <View
            ...
            {filteredFaqs.map(item => (
              <View
                ...
                style={[
                  styles.faqItem,
                  {borderBottomColor: COLORS1?.background},
                ]}>
                <TouchableOpacity
                  style={styles.faqQuestion}
                  onPress={() => toggleExpandItem(item.id)}>
                  <Text
                    style={[styles.questionText, {color: COLORS1?.textDark}]}>
                    {item.question}
                  </Text>
                  <View
                    style={
                    ...
                    <ChevronDownIcon color={COLORS1?.cheveronIcon} />
                  </View>
                </TouchableOpacity>
                {expandedItem === item.id && item.answer && (
                  <View style={styles.answerContainer}>
                    <Text
                      style={[styles.answerText, {color: COLORS1?.textDark}]}>
        ...
        <View style={styles.contactItemsContainer}>
          {contactItems.map(item => (
            <TouchableOpacity
              ...
              <Text style={[styles.contactName, {color: COLORS1?.textDark}]}>
                {item.name}
              </Text>
            </TouchableOpacity>
          ))}
